                    ...
                    <nav style={style}>
                        <div className="white blue-grey-text text-darken-1 nav-wrapper">
                            ...
                            <ul id="nav-mobile" className="right hide-on-med-and-down">
                                {!this.state.loggedIn ? <li><a className="blue-grey-text text-darken-1" onClick={this.gotoFAQ}>FAQ</a><a  href="#modalLogin" className="blue-grey-text text-darken-1 modal-trigger login-modal">Login</a></li> : <li> <a className="blue-grey-text text-darken-1 dropdown-button" href="#!" data-activates="dropdown1"> Welcome {window.currentUser.firstName}<i className="material-icons right">arrow_drop_down</i></a></li>}
                            </ul>
